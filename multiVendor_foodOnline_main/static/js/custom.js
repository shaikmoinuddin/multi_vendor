...
$(document).ready(function(){
    ...
    // place the cart item quantity on load(add_to_cart)
    ...
    $('.decrease_cart').on('click', function(e){
        ...
        $.ajax({
            type : 'GET',
            url : url,
            // data : data,(by default the food_id will come with the url)
            success : function(response){
                console.log(response);
                if(response.status == 'login_required'){
                    //sweetalert
    ...
    // delete the cart element if the quantity is 0(helper function)
